...
export default function AdminPage() {
  ...
  const MOCK_CIRCLES = useMemo(() => [
    ...
    { id: 'DEMO03', name: '$ 15.000', targetCapital: 15000, totalInstallments: 84, currentMemberCount: 163, memberCapacity: 168, subscriptionFeeRate: 3, administrativeFeeRate: 10, lifeInsuranceRate: 0.09, drawMethodCount: 1, bidMethodCount: 1, status: 'Active', isPrivate: false, creationDate: new Date().toISOString(), adminVatApplied: true, subscriptionVatApplied: true, lifeInsuranceVatApplied: false, isRecurrent: false, moraRate: 3, bidCommissionRate: 3, installmentDueDay: 5, accumulatedCommonFund: 0 },
    { id: 'DEMO04', name: '$ 10.000', targetCapital: 10000, totalInstallments: 84, currentMemberCount: 84, memberCapacity: 168, subscriptionFeeRate: 3, administrativeFeeRate: 10, lifeInsuranceRate: 0.09, drawMethodCount: 1, bidMethodCount: 1, status: 'Active', isPrivate: false, creationDate: new Date().toISOString(), adminVatApplied: true, subscriptionVatApplied: true, lifeInsuranceVatApplied: false, isRecurrent: false, moraRate: 3, bidCommissionRate: 3, installmentDueDay: 5, accumulatedCommonFund: 0 },
    { id: 'DEMO05', name: '$ 7.500', targetCapital: 7500, totalInstallments: 48, currentMemberCount: 10, memberCapacity: 96, subscriptionFeeRate: 3, administrativeFeeRate: 10, lifeInsuranceRate: 0.09, drawMethodCount: 1, bidMethodCount: 1, status: 'Active', isPrivate: false, creationDate: new Date().toISOString(), adminVatApplied: true, subscriptionVatApplied: true, lifeInsuranceVatApplied: false, isRecurrent: false, moraRate: 3, bidCommissionRate: 3, installmentDueDay: 5, accumulatedCommonFund: 0 },
  ], []);
