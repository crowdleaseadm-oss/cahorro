          ...
          {!isUserLoading && (
            <>
              {user && !user.isAnonymous ? (
                <Button asChild size="lg" className="h-11 px-6 text-sm font-bold rounded-xl shadow-lg shadow-primary/20 gap-2">
                  <Link href="/dashboard">
                ...
                <>
                  <AuthDialog 
                    defaultMode="login" 
                    trigger={<Button variant="ghost" className="font-bold text-sm h-11 px-6 rounded-xl hover:bg-primary/5 hover:text-primary">Ingresar</Button>} 
                  />
                  <AuthDialog 
                    defaultMode="register" 
                    trigger={<Button size="lg" className="h-11 px-6 text-sm font-bold rounded-xl shadow-lg shadow-primary/20">Empezar ahora</Button>} 
                  />
                </>
              )}
            </>
